...
function printPlaceholderThumbHtml() {
  return `        <button type="button" class="print-thumb print-thumb--placeholder" role="tab" aria-selected="false" data-placeholder="true" aria-label="Framed photo coming soon">
...
function printGalleryHtml(poster) {
  ...
  const extraThumbs = [0, 1].map((i) =>
    extras[i] ? printThumbHtml(extras[i], "Framed print") : printPlaceholderThumbHtml()
  );
