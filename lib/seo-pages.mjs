...
function printGalleryHtml(poster) {
  ...
  return `<div class="print-gallery" data-print-gallery>
    ...
    <div class="print-thumbs" role="tablist" aria-label="${title} photos">
        <button type="button" class="print-thumb is-active" role="tab" aria-selected="true" data-src="${src}" aria-label="Print">
          <img src="${src}" alt="" />
        </button>
        <button type="button" class="print-thumb print-thumb--placeholder" role="tab" aria-selected="false" data-placeholder="true" aria-label="Framed photo coming soon">
